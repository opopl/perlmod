...
package OP::TEX::Driver::FilterProgram;
...
sub execute {
    ...
    if (my $e = OP::TEX::Driver::Exception->caught()) {
        $e->show_trace(1);
...
=head1 SYNOPSIS
  ...
  OP::TEX::Driver::FilterProgram->execute(format => $format);
...
OP::TEX::Driver distribution.  It implements the guts of those filter
programs.
...
programs, gathering the parameters for the C<OP::TEX::Driver> object
...
C<OP::TEX::Driver> module for latex formatting.  Template variables may
...
The module invokes the C<OP::TEX::Driver> module and optionally the
...
C<OP::TEX::Driver> module.  Those programs have their own set of
